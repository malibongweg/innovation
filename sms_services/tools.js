    ...
    onComplete: function(response) {
							if (parseInt(response) == -9) {
								...
								switch (parseInt(response)) {
									...
									case 0: {	$('ccard').set('html','<b>PHOTOCOPY<br /><span style="color: #339900">Open</span>&nbsp;<a id="bucopy" href="1"><span style="color: #000000; font-weight: bold">&nbsp;[Block]</span></a>');
												 break;
												}
									case 1: {
												$('ccard').set('html','<b>PHOTOCOPY<br /><span style="color: #ff0000">Blocked</span>&nbsp;<a id="bucopy" href="0"><span style="color: #000000; font-weight: bold">&nbsp;[UnBlock]</span></a>');
												 break;
												}
								}
							}
    ...
    onComplete: function(response) {
							if (parseInt(response) == -1) {
								...
								switch (parseInt(response)) {
									...
									case 0: {	$('mcard').set('html','<b>MEALS<br /><span style="color: #339900">Open</span>&nbsp;<a id="bumeals" href="1"><span style="color: #000000; font-weight: bold">&nbsp;[Block]</span></a>');
												 break;
												}
									case 1: {
												$('mcard').set('html','<b>MEALS<br /><span style="color: #ff0000">Blocked</span>&nbsp;<a id="bumeals" href="0"><span style="color: #000000; font-weight: bold">&nbsp;[UnBlock]</span></a>');
												 break;
												}
								}
							}
