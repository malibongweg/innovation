...
$doc->addScript("scripts/its/pinrequest/itspin.js");
    ...
    <div class="art-block-body">
        <div class="art-blockheader">
            ...
            <h3 class="t" >
                 ...
                 Student ITS Pin Request System4</h3>
        </div>
            ...
            <div class="art-blockcontent-body">
                ...
                <div id="security-questions" class="main-div" style="display: none">
                    ...
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td width="100%"><strong>What is your Home Language?</strong><br /><input type="text" name="language" id="language" size="50" readonly class="input_field"/></td>
                        </tr>
                        <tr>
                            <td width="100%"><strong>What is your Residential/Postal address?</strong><br /><input type="text" name="address" id="address" size="50"  readonly class="input_field"></td>
                        </tr>
                        <tr>
                            <td width="100%"><strong>What is your 1st choice Qualification?</strong><br /><input type="text" name="qual" id="qual" size="50" readonly class="input_field"></td>
                        </tr>
                        <tr>
                            <td width="100%"><strong>Who is responsible for paying your fees?</strong><br /><input type="text" name="fees" id="fees" size="50" readonly class="input_field"></td>
                        </tr>
                        <tr>
                            <td align="center"><input type="button" id="getpin" class="button" value="Request Pin" style="display: none"/></td>
                        </tr>
                    </table>

                    <div id="show-pin" style="text-align: center; padding: 3px; background-color: #c9c9c9; border: 1px solid #9d9d9d">
