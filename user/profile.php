...
<div class="main-div" id="table-header" style="background-color: #e7feeb">
		...
		<p style="padding: 3px; background-color: #8effab; border: 2px solid #64ff64">
			...
			<input type="text" name="stno" size="10" id="staff-number"  class="input_field" readonly/><br style="clear: both" />
			...
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			<!--input type="text" name="new_title" size="5" id="new-title" class="input_field" style="display: none; border: 1px solid #fb5e4c" onKeyUp="this.value=this.value.toUpperCase();" /-->
			<br style="clear: both" />
			...
			<!--input type="text" name="new_faculty" size="30" id="new-faculty" class="input_field" style="display: none; border: 1px solid #fb5e4c" onKeyUp="this.value=this.value.toUpperCase();" /-->
			<br style="clear: both" />
			...
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			<select name="new_dept" id="new-dept" size="1" class="input_select" style="width: 200px; border: 1px solid #fb5e4c; display: none" />
				<?php
			...
			<!--input type="text" name="new_dept" size="30" id="new-dept" class="input_field" style="display: none; border: 1px solid #fb5e4c" onKeyUp="this.value=this.value.toUpperCase();" /-->
			<br style="clear: both" />
			...
			<!--div id="cell-msg" style="float: right; display: none"><a href="/index.php?option=com_jumi&fileid=81&view=application&tmpl=component" class="modalizer" style="color: red; font-weight: bold">!Important Message...Click here.</a></div-->
			<br style="clear: both" />

			<label class="input_label">Designation:</label>
			<input type="text" name="job_title" size="30" id="job-title"  class="input_field" readonly/>
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			...
			<!--input type="text" name="new_jobtitle" size="30" id="new-jobtitle" class="input_field" style="display: none; border: 1px solid #fb5e4c" onKeyUp="this.value=this.value.toUpperCase();" /-->
			<br style="clear: both" />

			<label class="input_label">Line Manager:</label>
			<input type="text" name="line_manager" size="30" id="line-manager"  class="input_field" readonly/>
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			<select name="new_line_manager" id="new-line-manager" size="1" class="input_select" style="width: 200px; border: 1px solid #fb5e4c; display: none" />
				<?php
...
<div class="main-div" id="table-header" style="background-color: #e7feeb">
			...
			<input type="text" name="campus" size="30" id="campus-name"  class="input_field" readonly/>
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			...
			<!--input type="text" name="new_campus" size="30" id="new-campus" class="input_field" style="display: none; border: 1px solid #fb5e4c" onKeyUp="this.value=this.value.toUpperCase();" /-->
			<br style="clear: both" />

			<label class="input_label">Building:</label>
			<input type="text" name="building" size="30" id="building-name"  class="input_field" readonly/>
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			...
			<!--input type="text" name="new_building" size="30" id="new-building" class="input_field" style="display: none; border: 1px solid #fb5e4c" onKeyUp="this.value=this.value.toUpperCase();" /-->
			<br style="clear: both" />

			<label class="input_label">Floor#</label>
			<input type="text" name="floor_no" size="6" id="floor-no"  class="input_field" readonly/>
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			...
			<input type="text" name="room_no" size="6" id="room-no"  class="input_field" readonly/>
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			...
			<input type="text" name="ext_no" size="15" id="ext-no"  class="input_field" readonly/>
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			...
			<input type="text" name="speed_dial1" size="15" id="speed-dial1"  class="input_field" readonly/>
			<span style="font-bold; color: #ff3300; font-size: 14px">*</span>
			<input type="text" name="new_speeddial" size="10" id="new-speeddial" class="input_field" style="display: none; border: 1px solid #fb5e4c" onKeyUp="this.value=this.value.toUpperCase();" />
			<br style="clear: both" />
