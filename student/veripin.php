<?php
$doc->addScript("scripts/student/veripin.js");
$doc->addScript("scripts/fav_apps.js");
$doc->addScript("scripts/json.js");
$doc->addStyleSheet("scripts/tables.css");
$dbo->setQuery("call proc_pop_application('Student iEnabler Pin Request')");
$dbo->query();
?>
...
<!--td style="width: 10%;height: 24px; border: 1px solid #3C619C; background-color: #3C619C; color: #FFFFFF; padding: 1px"><strong>CAN</strong></td-->
</tr>
</table>
</div>
