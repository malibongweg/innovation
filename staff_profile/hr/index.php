...
$doc->addScript('scripts/staff_profile/hr/index.js');
...
<input type="hidden" id="login-name" value="<?php echo $user->username; ?>" />
	...
	<div class="art-block">
			...
			<a href="#" id="fav-app"><img src="images/fav.png" width="16" height="16" style="vertical-align: middle" title="1Add to favorite." /></a>
       Staff Profile (HR Module) <span id="hr-details"></span></h3>
        </div>
