...
if (isset($_GET['action'])) {
    ...
    if ($_GET['action'] == 'srch') {
       ...
       echo json_encode($data);
        ...
        $sql1 = sprintf("insert into teaching_practice.SchoolTab (schoolname,address1,address2,address3,address4,postalcode,telephone,faxnumber,email,principal,liaison,language,num_students,schooltype, catergory)
               values ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s',%d,'%s','%s')",$_POST['school_name'], $_POST['address_1'],$_POST['address_2'],$_POST['address_3'],$_POST['address_4'],$_POST['postal_code'],$_POST['telephone_number'],$_POST['fax_number'],$_POST['email_address'],$_POST['principal_name'],$_POST['liaison_person'],$_POST['language_used'],$_POST['number_of_students'],$_POST['school_type'],$_POST['school_cat']);
        $dbo->setQuery($sql1);
    ...
    else if($_GET['action'] == 'delete_school')
    {
        ...
        $sql1 = sprintf("update teaching_practice.SchoolTab set schoolname='%s',address1='%s',address2='%s',address3='%s',address4='%s',postalcode='%s',telephone='%s',faxnumber='%s',email='%s',principal='%s',liaison='%s',language='%s',num_students=%d,schooltype='%s',catergory='%s' where schoolcode=%d",
               $_GET['schoolname'], $_GET['address1'],$_GET['address2'],$_GET['address3'],$_GET['address4'],$_GET['postcode'],$_GET['tel'],$_GET['fax'],$_GET['email'],$_GET['principal'],$_GET['liaison'],$_GET['lang_used'],$_GET['num_students'],$_GET['schtype'],$_GET['catergory'],$_GET['school_id_upd']);
