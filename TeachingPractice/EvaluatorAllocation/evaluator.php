        ...
        <div class="art-blockcontent" >
            <div class="art-blockcontent-body">
                ...
                <div id="user-details" class="main-div" style="display: none">
                    ...
                    <label class="input_label">Category:</label>&nbsp
                    <input type="text" name="category" id="category" size ="30" class="input_field"/><br/>
                    ...
                    <form id="evaluator-info">
                        <div id="evaluator-data" style="display: block">
                            ...
                            <select name="category" id="category" size="1" style="width: 200px;margin-left: 8px;" class="input_select">
                                <option value="Choose Category" selected="selected">Choose Category</option>
                                <?php
                                $sql = sprintf("select * from teaching_practice.CatEval");
                                $dbo->setQuery($sql);
                                $result = $dbo->loadObjectList();
