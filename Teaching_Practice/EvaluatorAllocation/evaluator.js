...
window.addEvent('domready', function() {
    ...
    $('evaluator-info').addEvent('submit', function (e) {
        e.stop();
        var x = new Request({
            url: 'index.php?option=com_jumi&fileid=193&action=save_evaluator',
            method: 'post',
            data: this,
            async: false,
    ...
    $('update-but').addEvent('click', function(e) {
        ...
        var x = new Request({
            url: 'index.php?option=com_jumi&fileid=193&evaluator_id_upd='+eval_id_update+'&evaluator_name=' + evaluator_name + '&evaluator_surname=' + evaluator_surname + '&id_number=' + id_number + '&address1=' + address1 + '&address2=' + address2 + '&address3=' + address3 + '&address4=' + address4
...
function showInfo(evalseqno) {
    ...
    var x = new Request({
        url: 'index.php?option=com_jumi&fileid=193&evalid='+evalseqno+'&action=info&dt='+new Date().getTime(),
        method: 'get',
        onComplete: function(response) {
...
{
    var x = new Request({
        url: 'index.php?option=com_jumi&fileid=193&eid='+eval_id_delete+'&action=delete_evaluator',
        method: 'get',
        onComplete: function(response) {
            if (response == 1)
            {
...
function listEvaluators() {
    ...
    var x = new Request ({
        url: 'index.php?option=com_jumi&fileid=193&action=display_evaluators',
        noCache: true,
        method: 'get',
        onComplete: function(response) {
            var row = json_parse(response,function(data,text) {
...
function srchSchool() {
    var x = new Request({
        url: 'index.php?option=com_jumi&fileid=193&evaluator=' + $('srch').value + '&action=srch&dt=' + new Date().getTime(),
        method: 'get',
        onComplete: function(response) {
            $('evaluator-List').empty();
            var row = json_parse(response, function(data, text) {
...
function displayEvaluatorInfo(eval_id) {
    ...
    var x = new Request({
        url: 'index.php?option=com_jumi&fileid=193&evalid=' + eval_id + '&action=evalinfo&dt=' + new Date().getTime(),
        method: 'get',
        onComplete: function(response) {
...
$('header-details3').setStyle('display','block');
    ...
    var x = new Request ({
        ...
        url: 'index.php?option=com_jumi&fileid=193&lang='+lang_id+'&subj_id='+subj_id+'&action=display_schools',
        noCache: true,
        method: 'get',
        onComplete: function(response) {
$('header-details3').setStyle('display', 'block');
...
function listSchoolSubjects() {
    ...
    var x = new Request ({
        ...
        url: 'index.php?option=com_jumi&fileid=193&subj_id='+subj_id+'&lang='+lang_id+'&action=display_schools_subs',
        noCache: true,
        method: 'get',
        onComplete: function(response) {
$('header-details3').setStyle('display', 'block');
...
var index =0;
    ...
    var x = new Request ({
        url: 'index.php?option=com_jumi&fileid=193&subject_id='+subject+'&action=display_students',
        noCache: true,
        method: 'get',
...
function checkChecked()
{
    ...
    if(index >= 0) {
        var x = new Request({
            url: 'index.php?option=com_jumi&fileid=193&stnum=' + val + '&eval_name=' + evaluator_name + '&eval_sname=' + evaluator_surname + '&action=allocate_student',
            method: 'get',
            ...
            onComplete: function (response) {
                ...
                {
                    alert('cannot evaluate same student twice');
                }
                else {
...
function deleteChecked()
{
    ...
    if(index >= 0) {
        var x = new Request({
            url: 'index.php?option=com_jumi&fileid=193&stnum=' + val + '&eval_name=' + evaluator_name + '&eval_sname=' + evaluator_surname + '&action=delete_student',
            method: 'get',
...
function listSelectedStudent(student_number,sch,subj)
{
    ...
    var x = new Request ({
        url: 'index.php?option=com_jumi&fileid=193&student_number='+student_number+'&subject='+subj+'&school='+sch+'&action=display_selected_student',
        noCache: true,
        method: 'get',
        onComplete: function(response) {
            var row = json_parse(response,function(data,text) {
...
function listEvaluatorStudents(eval_id) {
    ...
    var x = new Request ({
        url: 'index.php?option=com_jumi&fileid=193&action=display_students_info&eval_id='+eval_id,
        noCache: true,
        method: 'get',
        onComplete: function(response) {
            var row = json_parse(response,function(data,text) {
