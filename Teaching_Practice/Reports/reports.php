            ...
            <div class="art-blockcontent-body">
                ...
                <div id="search-school" style="width: auto; height: auto; display: none; margin-bottom: 5px">
                    ...
                    <fieldset class="input_fieldset">
                        ...
                        <input type="button" name="full_schools_report" id="full-schools-report" value="Run Full Schools Report" class="button art-button" ><br/><br/>
                        Search School<br />
                ...
                <div id="school-details" class="main-div" style="display: none">
                    ...
                    <input type="button" id="email-school-report" class="button art-button" value="Email School">
