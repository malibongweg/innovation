...
while ($row = mysql_fetch_object($res)){
	...
	$sql = sprintf("insert into miss.maimoi (maiglcc,maiglacc,maiitemno,maidnamt,maiapamt,maifmc,maiprmset) values ('%s','%s',1,%0.0f,%0.0f,1,'CC16')",$row->cc,$row->acc,$row->amt,$row->amt);
