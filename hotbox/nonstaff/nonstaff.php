...
$doc->addScript("scripts/hotbox/nonstaff/nonstaff.js");
...
<form id="app-details">
<input type="hidden" id="app-name" value="Hotbox - Non Staff Data" />
...
<div class="main-header"><span id="frame-title" style="font-weight: bold">Non Staff Data</span></div>
	<div style="position: relative; clear: both; margin: 10px 0 0 0"></div>
...
<!----------------------------------------------Staff Data Form----------------------------------------------------------------------------------------------------------------->
        <div class="main-div" id="staff-forms">
                    <div class="main-header"><strong>Update Non Staff Data</span></strong></div>
                    <!--form-->
                    <div id="staffData" style="position: relative; width: auto; height: auto; display: block">
                        ...
                        <form id="staffForm">
                            <input type="hidden" id="staff-action" />
                                ...
                                <input type="text" size="10" name="cardno" id="cardNo"/><!-- class="numeric" maxlength="4" />-->
                                    <br/>
                                    <br/>
                                <label class="input_label">&nbsp;</label>                                
                                    <input type="submit" value="Save Data" id="staff-save" class="button art-button"/>&nbsp;
