...
$doc->addScript("scripts/jobcards/ja.js");
...
<a href="#" class="modalizer" id="prnCard" /></a>

<input type="hidden" id="jid-value" value="<?php echo $_GET['jid']; ?>" />


<div id="tableAssignedArtisans"></div>