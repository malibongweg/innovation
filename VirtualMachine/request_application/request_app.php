        ...
        <div class="art-blockcontent" >
            <div class="art-blockcontent-body">                
                <div class="main-div" id="md" style="display: none;">
                    ...
                    <label><b>ID:</b></label>
                    <input type="text" size="15" name="idvm" id="idvm" class="input_field"/> <input type="button" id="get-vm" class="button art-button" value="View Request" />
                    <div style="position: relative; clear: both; margin: 10px 0 0 0"></div>
                    ...
                    <div id="vm-data" style="position: relative; width: auto; height: auto; display: block;">
                        ...
                        <form id="vm-request-form">
                            ...
                            <div class="main-div" id="vm-request-div">                                         
                                ...
                                <input type="text" size="15" name="p_num" id="p_num" class="input_field" onKeyUp="javascript: this.value=this.value.toUpperCase();" style="readonly:readonly;"/><br />
                            ...
                            <div class="main-div" id="vm-request-div">                                         
                                ...
                                <label class="input_label">Location:</label>
                                    ...
                                    <input type="text" size="35" name="prod_test" id="prod_test" class="input_field" onKeyUp="javascript: this.value=this.value.toUpperCase();"/><br />
                                    <label class="input_label">Status:</label>
                                    <input type="text" size="35" name="status" id="status" class="input_field" onKeyUp="javascript: this.value=this.value.toUpperCase();"/><span><br /><br/>
                                    
                                 
                                        
                                        <span style="display: none;" id="show-reccomendation">
                                            <label class="input_label">Recomendation:</label><br />
                                            <textarea cols="33" rows="5" name="reccomendation" id="reccomendation"> </textarea><br /><br />
                                        </span>
                                        
                                 
                                 
                                <div style="display: none;" id="show-approval-comment">
                                 ...
                                 <select id="approval" name="approval" id="approval" size="1" class="input_select" style="width: 200px;">
                                    ...
                                    <label class="input_label">Comments:</label><br />
                                    <textarea cols="33" rows="5" name="approval-comment" id="approval-comment"> </textarea><br /><br />
                                </div>
                                        
                                        <div id="ok" style="display: none;">
                                <input type="button" value="OK" id="ok" class="button art-button"/><br/>                                
                             </div>
                                        
                                         <div id="okkk" style="display: none;">
                                <input type="button" value="OK" id="ok" class="button art-button"/><br/>                                
                             </div>
                                        
                             <div style="display: none; margin-left: 250px;" id="okbut22">
                                <input type="button" value="OK"  class="button art-button"/><br/>                                
                            </div>
                                        
                            </div>
                            <div align="center" id="buts">
                            ...
                            <div style="display: none;" id="show-recbut">
                                    <input type="button" value="Send Reccomendation" id="recomend" class="button art-button"/>
                                    <input type="button" value="Cancel" id="cancel2" class="button art-button"/><br/>                                
                            </div>
                            
                            <div style="display: none;" id="show-approval-but">
                                    <input type="button" value="Approve VM Request" id="approvevm" class="button art-button"/>
                                    <input type="button" value="Cancel" id="cancel3" class="button art-button"/><br/>                                
                            </div>
