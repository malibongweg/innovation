...
$thumbs_path = $images_path . "thumbs/".date('d-m-Y')."/"; //this is you destination thumbmail folder, you can change it if you want, just be sure the folder actually exists and is writeable by the web server.  In this example, we don't deal with duplicate names, so we just store the cropped verion in a different folder.
...
$userid = isset($_POST['uid']) ? $_POST['uid'] : false;
